<?php if (!defined('THINK_PATH')) exit();?><div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" action="/res/admin.php/training/applicantUnit?_=1455951385493" method="post">
        ...
        <div class="bjui-searchBar">
            <select name="searchtype" data-toggle="selectpicker">
                <option value="0"<?php if(($searchtype) == "0"): ?>selected<?php endif; ?>><?php echo L('applicant_unit');?></option>
            </select>&nbsp;
            ...
            <div class="pull-right">
                <button type="button" class="btn-green" data-url="<?php echo U('Training/addApplicantUnit');?>/" data-toggle="navtab" data-id="article_edit"><?php echo L('add');?></button>&nbsp;
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu right" role="menu">
                        <li><a href="<?php echo U('Training/deleteApplicantUnit');?>" data-toggle="doajaxchecked" data-confirm-msg="<?php echo L('msg_confirm_delete');?>" data-idname="ids" data-group="ids"><?php echo L('del_checked');?></a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <table data-toggle="tablefixed" data-width="100%" data-nowrap="true">
        ...
        <tbody>
            <?php if(is_array($page_list)): foreach($page_list as $key=>$item): ?><tr data-id="<?php echo ($item[id]); ?>">
                ...
                <td align="center">
                	<a class="btn btn-green" href="<?php echo U('Training/editApplicantUnit?id='.$item['id']);?>" data-toggle="dialog" data-id="Training_edit"><span><?php echo L('edit');?></span></a>
                    <a class="btn btn-red" href="<?php echo U('Training/deleteApplicantUnit?ids='.$item['id']);?>" data-toggle="doajax" data-confirm-msg="<?php echo L('msg_confirm_delete');?>"><span><?php echo L('delete');?></span></a>
                </td>
