...
<script type="text/javascript" src="/Public/assets/global/plugins/jquery-validation/js/jquery.validate.min.js"></script>
<script type="text/javascript" src="/Public/assets/global/plugins/jquery-validation/js/localization/messages_zh.min.js"></script>
<script type="text/javascript" src="/Public/assets/global/plugins/jquery-validation/js/additional-methods.min.js"></script>
...
<div class="page-footer">
    <div class="page-footer-inner">
         Copyright &copy; <?php echo date("Y");?>.HL <a href="/index.php/Home/Publics/index" target="_blank">test.com</a> All rights reserved.
    </div>
