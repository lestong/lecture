    ...
    $(document).on(BJUI.eventType.initUI, function(e) {
        ...
        $box.find('[data-toggle="kindeditor"]').each(function() {
            ...
            KindEditor.create($editor, {
                ...
                uploadJson               : options.uploadjson || '/admin.php/Attachment/ali_uploadJson',			//更改默认的上传控件
                fileManagerJson          : options.filemanagerjson,	//更改默认的空间控件
                allowFileManager         : options.allowFileManager || false,
